...
/**
 * express will call one middleware one after the other and wherever the response will get send which will known as request handler
 */
app.use(
  "/hello",
  (req, res, next) => {
...
/**
 * 3. We can use middleware also to handle error handling, though try catch will be the better way to handle the errors
 * always write
 *
 ...
 *   }
 * });
 * Though its better to write the whole code in a try catch block
 *
 */
